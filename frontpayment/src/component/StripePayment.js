...
function StripePayment() { 
  ...
  const makePayment = async () => { 
    const stripe = await loadStripe("pk_test_51Mk1bnFSAsStW2oB2iaDJgrlJ704ptpnvQnUoChI98GqNrGoO7H5ctpkYVyJaNqFI8Klu4HsRRDOpciaTNCH1v06005HiKXpTf"); 
    const body = { product }; 
    const headers = { 
    ...
    const response = await fetch( 
      "http://localhost:4546/api/checkstripe", 
      { 
        method: "POST", 
        headers: headers, 
